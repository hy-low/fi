...
Työkalun saa käyttöön kääntämällä ohjelman seuraavasti:
...
```console
=================================================================
==31403==ERROR: AddressSanitizer: heap-buffer-overflow on address 0x5140000001d0 at pc 0x5ae1acabb21d bp 0x7ffd605991a0 sp 0x7ffd60599190
