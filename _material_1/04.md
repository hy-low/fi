...
Linuxissa muistinhallinta on toteutettu niin, että ohjelmien virtuaaliset muistiosoitteet ovat välillä `0x000000000000` ja `0x7fffffffffff`. Pinolle varattu muistialue on tämän välin lopussa ja muut muistialueet sijaitsevat aiemmin välillä.

Voimme saada käsitystä asista tutkimalla seuraavan ohjelman toimintaa:
...
Tämä sopii hyvin yhteen ohjelman näyttämien muistiosoitteiden kanssa. Voimme havaita, että muistiosoitteet osuvat seuraavilla alueille:
