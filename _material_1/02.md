...
Avainsana `struct` määrittelee rakenteisen tietotyypin, jonka sisällä on nimettyjä kenttiä. Esimerkiksi seuraava tietotyyppi `struct Position` sisältää kentät `x` ja `y`:
