...
Luku 123456 on tallennettu siis muistiin neljänä tavuna 64, 226, 1 ja 0. Luku 123456 muodostuu tavujen sisällöstä seuraavasti:
...
<div class="note" markdown="1">
Tässä käytössä on little endian -tavujärjestys, jossa tavut ovat muistissa "käänteisessä" järjestyksessä: ensimmäisenä vähiten merkitsevä tavu ja viimeisenä eniten merkitsevä tavu. Tätä tavujärjestystä käytetään yleisesti tietokoneiden prosessoreissa.
</div>
...
Tässä kentät vievät tilaa 5 tavua, mutta lisäksi on varattu 3 täytetavua, jotta muistialueen kooksi tulee yhteensä 8 tavua.
...
<div class="note" markdown="1">
Tässä liukuluku 3.14159 on tallennettu IEEE 754 -standardin mukaisena yksöistarkkuuden liukulukuna, joka muodostuu seuraavista osista:
