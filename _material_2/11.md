...
pinon tulee olla tasattu niin, että pinorekisteri `rsp` osoittaa muistissa 16 tavun rajaan. Tämä tarkoittaa, että aliohjelman tulee lisätä pinoon tavuja jokin luvun 16 moninkerta ennen toisen aliohjelman kutsumista.

<div class="note" markdown="1">
Tämä vaatimus liittyy tiedon siirtämiseen pinon ja tiettyjen x86-prosessorin vektorirekistereiden välillä. Tiedon siirto on tehokkaampaa tai on mahdollista vain silloin, kun pino on tasattu 16 tavun tavurajaan.
</div>
