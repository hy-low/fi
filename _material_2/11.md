...
Tehdään seuraavaksi aliohjelma, joka kutsuu itseään rekursiivisesti. Aliohjelman tehtävänä on laskea haluttu Fibonaccin luku seuraavan C-funktion tyylisesti:
...
Tässä tiedoston alussa `global calc_sum` tarkoittaa, että aliohjelma `calc_sum` on kutsuttavissa tiedoston ulkopuolelta.
...
Tässä funktion `calc_sum` esittely kertoo, että ohjelman käytettävissä on tällainen funktio. Tässä tapauksessa funktion toteutus on tehty konekielisenä aliohjelmana, joka linkitetään ohjelmaan käännösvaiheessa.
