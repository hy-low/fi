...
Tässä on vastaava konekielinen aliohjelma:
...
Tässä tapauksessa ja usein muutenkin tällä erolla on kuitenkin vähän merkitystä. Koska 32-bittisen rekisterin arvon asettaminen nollaa 64-bittisen rekisterin alkupuoliskon, esimerkiksi komennot `mov rdi, 1` ja `mov edi, 1` tuottavat saman tuloksen.
</div>
