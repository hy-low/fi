...
Tässä aliohjelman ensimmäinen parametri (`1`)  välitetään rekisterissä `rdi` ja toinen parametri (`100`) välitetään rekisterissä `rsi`. Aliohjelma laskee lukuvälin summan rekisteriin `rax`, josta tulee aliohjelman paluuarvo.
